use wayland_client::{delegate_noop, protocol::{wl_buffer::WlBuffer, wl_registry, wl_shm::WlShm, wl_shm_pool::WlShmPool}, Connection, Dispatch};

use crate::{buffer::Buffer, protocols::hyprland_toplevel_export_v1::{hyprland_toplevel_export_frame_v1::{self, HyprlandToplevelExportFrameV1}, hyprland_toplevel_export_manager_v1::HyprlandToplevelExportManagerV1}};
...
pub enum FrameStatus {
    ...
    Inactive,
    Active,
    FrameReady(Arc<Buffer>),
    Failed,
    FrameRequested(Arc<Buffer>),
    BufferDone(Arc<Buffer>),
